...
| `handlers_note.go` | `fmt`, `tea`, `codeberg.org/lthiagol/obsidian-terminal/internal/search` (for `search.NewState`) |
...
3. Add imports: `fmt`, `tea`, `codeberg.org/lthiagol/obsidian-terminal/internal/search`
