    ...
    steps:
      ...
      - name: Compute SHA256 of source tarball
        ...
        run: |
          ...
          URL="https://codeberg.org/lthiagol/obsidian-terminal/archive/refs/tags/${TAG}.tar.gz"
...
**Verification:**
- [ ] GitHub Release created at `https://codeberg.org/lthiagol/obsidian-terminal/releases/tag/v0.2.0`
